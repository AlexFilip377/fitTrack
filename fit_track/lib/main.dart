...
class FitnessHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // 1. ВЕРХНЯЯ ПАНЕЛЬ (Меню и ссылки)
            Padding(
            ...
            const Spacer(), // Пружина, которая толкает нижнюю часть вниз

            // 5. НИЖНЯЯ СТАТИСТИКА (KCAL и KM)
            Padding(
            ...
            // 6. НИЖНЕЕ МЕНЮ (Navigation Bar) — общее для всего приложения
  ...
  // Виджет для маленьких кружков статистики
